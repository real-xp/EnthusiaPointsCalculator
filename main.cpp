...
// Changes RS or R1 inclusion
static void ToggleRSOrR1Mode() {
    calcstruct.include_rs_rank_odds = !calcstruct.include_rs_rank_odds;
}



int APIENTRY main(HINSTANCE hInstance, HINSTANCE, LPTSTR, int) // change to _tWinMain for non console, main for console
{
    ...
    while (!done)
    {
        ...
        if (ImGui::BeginMenuBar())
        {
            if (ImGui::BeginMenu("App"))
            {
                ...
                if (ImGui::MenuItem("Include RS Odds", NULL, calcstruct.include_rs_rank_odds)) ToggleRSOrR1Mode();
